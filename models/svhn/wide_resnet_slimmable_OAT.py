...
class SlimmableWideResNet_16_8_OAT(nn.Module):
    def __init__(self, depth=16, num_classes=10, widen_factor=8, dropRate=0.0, FiLM_in_channels=1, use2BN=True):
        super(SlimmableWideResNet_16_8_OAT, self).__init__()
...
class SlimmableWideResNet_16_8_OAT_SOL(nn.Module):
    def __init__(self, depth=16, num_classes=10, widen_factor=8, dropRate=0.0, FiLM_in_channels=1, use2BN=True):
        super(SlimmableWideResNet_16_8_OAT_SOL, self).__init__()
        nChannels = [16, 16 * widen_factor, 32 * widen_factor, 64 * widen_factor]
        # nChannels = [16, 128, 256, 512]
